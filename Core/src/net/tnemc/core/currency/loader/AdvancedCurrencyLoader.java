...
import net.tnemc.core.currency.CurrencyNote;
import net.tnemc.core.currency.ItemTier;
import net.tnemc.core.currency.TNECurrency;
import net.tnemc.core.currency.TNETier;
import net.tnemc.core.currency.recipe.CurrencyLegacyShapedRecipe;
import net.tnemc.core.currency.recipe.CurrencyRecipe;
import net.tnemc.core.currency.recipe.CurrencyShapedRecipe;
import net.tnemc.core.currency.recipe.CurrencyShapelessRecipe;
import net.tnemc.core.utils.FileUtils;
...
import static net.tnemc.core.CurrencyManager.largestSupported;
