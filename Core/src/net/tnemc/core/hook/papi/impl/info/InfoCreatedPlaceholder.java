package net.tnemc.core.hook.papi.impl.info;
/*
 * The New Economy
 ...
 * @since 0.1.4.0
 */
public class InfoCreatedPlaceholder implements Placeholder {
  ...
  public boolean applies(final String[] params) {
    ...
    return params[0].equalsIgnoreCase("account") && params.length >= 3
           && params[1].equalsIgnoreCase("created");
  }
  ...
  public @Nullable String onRequest(@Nullable final String account, @NotNull final String[] params) {
    ...
    return TNECore.eco().transaction().getFormat().format(new Date(accountOptional.get().getCreationDate()));
  }
}