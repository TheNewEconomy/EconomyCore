 ...
 * @since 0.1.4.0
 */
public class InfoIDPlaceholder implements Placeholder {
  ...
  public @Nullable String onRequest(@Nullable final String account, @NotNull final String[] params) {
    ...
    return (UUIDProvider.isUUID(params[2]))? accountOptional.get().getName() : accountOptional.get().getIdentifier().toString();
  }
}