...
public class CurrencyMoneyCommand implements OrphanCommand {
  ...
  public void onBalance(final BukkitCommandActor sender, @Default("world-113") @Named("region") final String region) {
  ...
  public void onConvert(final BukkitCommandActor sender, @Named("amount") final PercentBigDecimal amount, @Named("currency") final Currency toCurrency) {
    ...
    net.tnemc.core.command.MoneyCommand.onConvert(new PaperCMDSource(sender), amount, toCurrency, this.currency);
  }
  ...
  @EnderSupport
  @AllSupport
  public void onDeposit(final BukkitCommandActor sender, @Named("amount") final ParseMoney amount, @Default("world-113") @Named("region") final String region) {
  ...
  public void onGiveNote(final BukkitCommandActor sender, @Named("account") final Account player, @Named("amount") final ParseMoney amount) {
  ...
  @EnderSupport
  @AllSupport
  public void onNote(final BukkitCommandActor sender, @Named("amount") final ParseMoney amount) {
  ...
  @EnderSupport
  @AllSupport
  public void onPay(final BukkitCommandActor sender, @Named("account") final Account player, @Named("amount") final ParseMoney amount) {
  ...
  public void onTop(final BukkitCommandActor sender, @Default("1") final Integer page, @Default("false") final Boolean refresh) {
  ...
  @AllSupport
  public void onWithdraw(final BukkitCommandActor sender, @Named("amount") final ParseMoney amount, @Default("world-113") @Named("region") final String region) {
