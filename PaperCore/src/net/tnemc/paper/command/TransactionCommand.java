...
public class TransactionCommand {
  ...
  public void away(BukkitCommandActor sender, @Default("1") int page) {
    net.tnemc.core.command.TransactionCommand.away(new PaperCMDSource(sender), page);
  }
  ...
  public void info(BukkitCommandActor sender, UUID uuid, @Default("SELF_ACCOUNT") Account account) {
    net.tnemc.core.command.TransactionCommand.info(new PaperCMDSource(sender), uuid, account);
  }
