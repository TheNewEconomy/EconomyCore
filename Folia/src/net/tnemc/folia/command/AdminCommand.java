...
public class AdminCommand {
  ...
  public void backup(BukkitCommandActor sender) {
    net.tnemc.core.command.AdminCommand.onBackup(new FoliaCMDSource(sender));
  }
  ...
  public void create(BukkitCommandActor sender, String name) {
    net.tnemc.core.command.AdminCommand.onCreate(new FoliaCMDSource(sender), name);
  }
  ...
  public void debug(BukkitCommandActor sender, DebugLevel level) {
    net.tnemc.core.command.AdminCommand.onDebug(new FoliaCMDSource(sender), level);
  }
  ...
  public void delete(BukkitCommandActor sender, String name) {
    net.tnemc.core.command.AdminCommand.onDelete(new FoliaCMDSource(sender), name);
  }
  ...
  public void extract(BukkitCommandActor sender) {
    net.tnemc.core.command.AdminCommand.onExtract(new FoliaCMDSource(sender));
  }
  ...
  public void purge(BukkitCommandActor sender) {
    net.tnemc.core.command.AdminCommand.onPurge(new FoliaCMDSource(sender));
  }
  ...
  public void reload(BukkitCommandActor sender, @Default("all") String type) {
    net.tnemc.core.command.AdminCommand.onReload(new FoliaCMDSource(sender), type);
  }
  ...
  public void reset(BukkitCommandActor sender) {
    net.tnemc.core.command.AdminCommand.onReset(new FoliaCMDSource(sender));
  }
  ...
  public void restore(BukkitCommandActor sender, @Default("0") int extraction) {
    net.tnemc.core.command.AdminCommand.onRestore(new FoliaCMDSource(sender), extraction);
  }
  ...
  public void old(BukkitCommandActor sender, @Default("0") int extraction) {
    ...
    new FoliaCMDSource(sender).message(new MessageData("Messages.Admin.Restoration"));
  }
  ...
  public void save(BukkitCommandActor sender) {
    net.tnemc.core.command.AdminCommand.onSave(new FoliaCMDSource(sender));
  }
  ...
  public void status(BukkitCommandActor sender, Account account, @Default("normal") AccountStatus status) {
    net.tnemc.core.command.AdminCommand.onStatus(new FoliaCMDSource(sender), account, status);
  }
  ...
  public void version(BukkitCommandActor sender) {
    net.tnemc.core.command.AdminCommand.onVersion(new FoliaCMDSource(sender));
  }
