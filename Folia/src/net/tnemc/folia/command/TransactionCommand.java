...
public class TransactionCommand {
  ...
  public void away(BukkitCommandActor sender, @Default("1") int page) {
    net.tnemc.core.command.TransactionCommand.away(new FoliaCMDSource(sender), page);
  }
  ...
  public void history(BukkitCommandActor sender, @Default("1") int page, String region, @Default("SELF_ACCOUNT") Account account) {
    net.tnemc.core.command.TransactionCommand.history(new FoliaCMDSource(sender), page, region, account);
  }
  ...
  public void info(BukkitCommandActor sender, UUID uuid, @Default("SELF_ACCOUNT") Account account) {
    net.tnemc.core.command.TransactionCommand.info(new FoliaCMDSource(sender), uuid, account);
  }
  ...
  public void voidT(BukkitCommandActor sender, Account account, UUID uuid) {
    net.tnemc.core.command.TransactionCommand.voidT(new FoliaCMDSource(sender), account, uuid);
  }
}
