...
public class ModuleCommand {
  ...
  public void onAvailable(BukkitCommandActor sender, @Default(TNECore.coreURL) String url) {
    net.tnemc.core.command.ModuleCommand.onAvailable(new FoliaCMDSource(sender), url);
  }
  ...
  public void onDownload(BukkitCommandActor sender, String moduleName, @Default(TNECore.coreURL) String url) {
    net.tnemc.core.command.ModuleCommand.onDownload(new FoliaCMDSource(sender), moduleName, url);
  }
  ...
  public void onInfo(BukkitCommandActor sender, String moduleName) {
    net.tnemc.core.command.ModuleCommand.onInfo(new FoliaCMDSource(sender), moduleName);
  }
  ...
  public void onList(BukkitCommandActor sender) {
    net.tnemc.core.command.ModuleCommand.onList(new FoliaCMDSource(sender));
  }
  ...
  public void onLoad(BukkitCommandActor sender, String moduleName) {
    net.tnemc.core.command.ModuleCommand.onLoad(new FoliaCMDSource(sender), moduleName);
  }
}