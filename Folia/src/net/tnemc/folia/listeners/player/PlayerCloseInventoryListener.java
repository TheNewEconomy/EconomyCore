package net.tnemc.folia.listeners.player;
/*
 * The New Economy
...
import net.tnemc.folia.impl.FoliaPlayerProvider;
...
public class PlayerCloseInventoryListener implements Listener {
  ...
  public void onClose(final InventoryCloseEvent event) {
    ...
    if(event.getInventory().getType().equals(InventoryType.ENDER_CHEST)) {
      ...
      final FoliaPlayerProvider provider = new FoliaPlayerProvider((OfflinePlayer)event.getPlayer());
